...
enum MenuSection: CaseIterable, Identifiable {
    ...
    case userManagement
    case developerTools
    // MOBILE-SSO End user dashboard launchpad
    case launchPad
    ...
    var title: String {
        ...
        // MOBILE-SSO add launchpad section
    ...
    var items: [MenuItem] {
        ...
        // MOBILE-SSO launch end user dasbboard
        case .launchPad:
...
enum MenuItem: String, CaseIterable, Identifiable {
    ...
    case enduserDashboard = "User Dashboard"
    ...
    var icon: String {
        ...
        // MOBILE-SSO End user dashboard menu item
        case .enduserDashboard: return "person.fill"
        }
    }
    ...
    var title: String {
        ...
        // MOBILE-SSO End user dashboard title
        case .enduserDashboard: return "User Dashboard"
        }
    }
    ...
    var subtitle: String {
        ...
        // MOBILE-SSO End user dashboard subtitle
        case .enduserDashboard: return "Profile settings"
        }
    }
}
    ...
    var body: some View {
        NavigationStack(path: $path) {
            ...
            .navigationDestination(for: MenuItem.self) { item in
                ...
                // MOBILE-SSO End user dashboard launch web view
                case .enduserDashboard:
                    let enduserDashboardUrl = Bundle.main.object(forInfoDictionaryKey: "enduserDashboardUrl") as! String;
                    WebViewScreen(url: enduserDashboardUrl)
                }
            }
            .task {
